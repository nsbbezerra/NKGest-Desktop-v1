...
function XmlImporter() {
    ...
    await api
      ...
      .then((response) => {
        ...
        setBaseCalculoIcmsRetido(
          response.data.infoProtocolo.baseCalculoIcmsRetido
        );
  ...
  const columnsProduct = [
    ...
    },
    {
      ...
      render: (value) => (
        <Statistic value={value} valueStyle={{ fontSize: 15 }} precision={0} />
      ),
      width: "6%",
      align: "center",
    },
    ...
    <>
      <Header>
        <p style={{ fontWeight: "bold", marginBottom: -0.01, fontSize: 18 }}>
          <Icon type="file-excel" style={{ fontSize: 20 }} /> IMPORTAR XML
        </p>
        <Link to="/">
      ...
      >
          ...
          <label id="xmlFile">
            ...
            {!xmlFile && (
              <p style={{ marginBottom: -0.5 }}>
                ...
                />
                Clique aqui para adicionar o arquivo XML da nota fiscal
              </p>
            )}
            {xmlFile && (
              <>
                <div style={{ display: "flex", flexDirection: "row" }}>
                  <p style={{ marginBottom: -0.5 }}>{xmlFile.name}</p>
                ...
                >
                  Clique em IMPORTAR XML para enviar o arquivo para o servidor
                </p>
              </>
            )}
          </label>
        ...
        >
          <Button
            ...
            onClick={() => sendXmlFile()}
            loading={loadindImport}
          >
            Carregar Dados da NFE
          </Button>
        </div>
          ...
          <>
            ...
            <Row gutter={10} style={{ marginBottom: 6 }}>
              ...
              <Col span={4}>
                ...
                <Input
                  value={moment(dataEmissao).format("DD/MM/YYYY")}
                  readOnly
                />
              </Col>
              <Col span={4}>
