...
import { Icon, Row, Col, Input, Button, Divider, Select, Switch, Card, Modal } from 'antd';
...
function Funcionarios() {
    ...
    async function RegisterFuncionario() {
        ...
        if (celUm === '') {
            warning('Atenção', 'O funcionário deve ter pelo menos um número de telefone cadastrado, Preencha o campo CELULAR 1');
            return false;
        }

        setLoading(true);

        await api.post('/register/funcionarios', {
            name: nome,
            gender: sexo,
            dateBirth: dataNasc,
            celOne: celUm,
    ...
    return (
        <>
            <Header>
                <p style={{ fontWeight: 'bold', marginBottom: -.01, fontSize: 18 }}><Icon type='idcard' style={{ fontSize: 20 }} /> CADASTRO DE FUNCIONÁRIOS</p>
            ...
            <div style={{ paddingTop: 15, paddingBottom: 15, paddingLeft: 30, paddingRight: 30 }}>
                ...
                <Row gutter={10} style={{ marginBottom: 7 }}>
                    ...
                    <Col span={4}>
                        ...
                        <Select value={sexo} style={{ width: '100%' }} onChange={(value) => setSexo(value)}>
                ...
                <Row gutter={10} style={{ marginBottom: 7 }}>
                    ...
                    <Col span={18}>
                        ...
                        <Card size='small' title='Permissões' headStyle={{ fontWeight: 'bold' }}>
                    ...
                    <Col span={6}>
                        ...
                        <Select value={cargoNome} style={{ width: '100%' }} onChange={(value) => setCargoNome(value)}>

                            <Option key={1} value='Administrador'>Administrador(a)</Option>
                            <Option key={2} value='Diretor'>Diretor(a)</Option>
                            <Option key={3} value='Gerente'>Gerente</Option>
                            <Option key={4} value='Caixa'>Caixa</Option>
                            <Option key={5} value='Vendedor'>Vendedor(a)</Option>
                            <Option key={6} value='Auxiliar de Almoxarifado'>Auxiliar de Almoxarifado</Option>
                            <Option key={7} value='Zelador'>Zelador(a)</Option>
                        ...
                        <label>Admissão<span style={{ color: 'red' }}>*</span></label>
                        <InputMask mask={'99/99/9999'} className='ant-input' onChange={(e) => setAdmissao(e.target.value)} value={admissao} />
                    ...
                    <>
                        ...
                        <Row gutter={10} style={{marginTop: 7}}>
                            ...
                            <Col span={12}>
                                ...
                                <Input.Password onChange={(e) => setSenha(e.target.value)} value={senha} />
                    ...
                    <>
                        ...
                        <Row gutter={10} style={{marginTop: 7}}>
                            ...
                            <Col span={8}>
                                ...
                                <Input type='number' addonAfter='%' disabled={!comissioned} onChange={(e) => setComissao(e.target.value)} value={comissao} />
                ...
                <Button type="primary" icon="save" size='large' loading={loading} onClick={() => RegisterFuncionario()}>
