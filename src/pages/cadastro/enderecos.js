...
import { Icon, Row, Col, Input, Select, Divider, TreeSelect, Button, Spin, Modal } from 'antd';
...
function Enderecos() {
    ...
    return (
        <>
            <Header>
                <p style={{ fontWeight: 'bold', marginBottom: -.01, fontSize: 18 }}><Icon type='environment' style={{ fontSize: 20 }} /> CADASTRO DE ENDEREÇOS</p>
            ...
            <div style={{ paddingTop: 15, paddingBottom: 15, paddingLeft: 30, paddingRight: 30 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', width: '100%', justifyContent: 'flex-start', alignItems: 'center' }}>
                    ...
                    <Button type="primary" icon="save" size='large' loading={loading} onClick={() => RegisterAddress()}>
                        Cadastrar Endereço
                    </Button>
