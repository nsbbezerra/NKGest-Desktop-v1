...
import { Icon, Row, Col, Input, Select, Divider, Checkbox, Button, Modal } from 'antd';
...
function Clientes() {
    ...
    function info() {
        Modal.info({
            ...
            content: (
                <div>
                    <p>Lembre-se que os dados dos <strong>veículos</strong> e <strong>endereços</strong> são dados importantes tanto para <strong>vendas</strong> quanto para <strong>ordens de serviço</strong>, entre na seção de cadastro de veículos e endereços para cadastrá-los para este cliente.</p>
                </div>
            ),
            onOk() { },
        });
    ...
    async function RegisterClient() {
        ...
        await api.post('/register/clientes', {
            name: nome,
            cpf_cnpj: cpf_cnpj,
            rg: rg,
    ...
    async function RegisterAddress() {
        ...
        await api.post('/register/enderecos', {
            client: idCliente,
            street: rua,
            number: numero,
            comp: complemento,
    ...
    return (
        <>
            <Header>
                <p style={{ fontWeight: 'bold', marginBottom: -.01, fontSize: 18 }}><Icon type='team' style={{ fontSize: 20 }} /> CADASTRO DE CLIENTES</p>
            ...
            <div style={{ paddingTop: 15, paddingBottom: 15, paddingLeft: 30, paddingRight: 30 }}>
                    ...
                    <>
                        <Row style={{ marginBottom: 7 }} gutter={10}>
                            ...
                            <Col span={4}>
                                ...
                                <Select defaultValue={typeClient} style={{ width: '100%' }} onChange={(value) => setTypeClient(value)}>
                            ...
                            <Col span={4}>
                                ...
                                <Select defaultValue={ativo} style={{ width: '100%' }} onChange={(value) => setAtivo(value)}>
                            ...
                            <Col span={10}>
                                ...
                                <Input autoCapitalize='words' value={nome} type='text' onChange={(e) => setNome(e.target.value.toUpperCase())} />
                            </Col>
                        ...
                        <Row style={{ marginBottom: 7 }} gutter={10}>
                            ...
                            <Col span={6}>
                                ...
                                <InputMask mask={'999.999.999-99'} className='ant-input' onChange={(e) => setCpf_cnpj(e.target.value)} value={cpf_cnpj} />
                            </Col>

                            <Col span={6}>
                                <label>RG<span style={{ color: 'red' }}>*</span></label>
                                <Input type='number' onChange={(e) => setRg(e.target.value)} value={rg} />
                            </Col>

                            <Col span={6}>
                                <label>Órgão emissor<span style={{ color: 'red' }}>*</span></label>
                                <Input autoCapitalize='characters' type='text' onChange={(e) => setOrgaoEmissor(e.target.value.toUpperCase())} value={orgaoEmissor} />
                            </Col>

                            <Col span={6}>
                                <label>Data de nascimento<span style={{ color: 'red' }}>*</span></label>
                                <InputMask mask={'99/99/9999'} className='ant-input' onChange={(e) => setDataNasc(e.target.value)} value={dataNasc} />
                            </Col>
                        ...
                        <Row gutter={10} style={{ marginBottom: 7 }}>
                            ...
                            <Col span={6}>
                                ...
                                <Input type='text' addonAfter={<Checkbox value='Isento' onChange={(value) => handleInscricaoEstadual(value)} checked={check}>Isento</Checkbox>} onChange={(e) => setInscricaoEstadual(e.target.value)} value={inscricaoEstadual} />
                            </Col>
                ...
                {typeClient === 'Pessoa Jurídica' && (
                    ...
                    <>
                        <Row style={{ marginBottom: 7 }} gutter={10}>
                            ...
                            <Col span={4}>
                                <label>Tipo de cliente</label>
                                <Select value={typeClient} style={{ width: '100%' }} onChange={(value) => setTypeClient(value)}>
                                    <Option value="Pessoa Física">Pessoa Física</Option>
                                    <Option value="Pessoa Jurídica">Pessoa Jurídica</Option>
                                </Select>
                            </Col>
                            ...
                            <Col span={4}>
                                <label>Situação<span style={{ color: 'red' }}>*</span></label>
                                <Select value={ativo} style={{ width: '100%' }} onChange={(value) => setAtivo(value)}>
                                    <Option value={true}>Ativo</Option>
                                    <Option value={false}>Bloqueado</Option>
                                </Select>
                            </Col>
                            ...
                            <Col span={10}>
                                ...
                                <Input type='text' onChange={(e) => setRazaoSocial(e.target.value.toUpperCase())} value={razaoSocial} />
                            </Col>
                        ...
                        <Row style={{ marginBottom: 7 }} gutter={10}>
                            ...
                            <Col span={8}>
                                ...
                                <InputMask mask={'99.999.999/9999-99'} className='ant-input' onChange={(e) => setCpf_cnpj(e.target.value)} value={cpf_cnpj} />
                            </Col>
                        ...
                        <Row gutter={10} style={{ marginBottom: 7 }}>
                            ...
                            <Col span={12}>
                                ...
                                <Input onChange={(e) => setInscricaoMunicipal(e.target.value)} value={inscricaoMunicipal} addonAfter={<Checkbox value='Isento' onChange={(value) => handleInscricaoMun(value)} checked={checkMun}>Isento</Checkbox>} />
                            </Col>

                            <Col span={12}>
                                <label>Responsável</label>
                                <Input type='text' onChange={(e) => setResponsavel(e.target.value.toUpperCase())} value={responsavel} />
                            </Col>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', width: '100%', justifyContent: 'flex-start', alignItems: 'center' }}>
                    ...
                    <Button type="primary" icon="save" size='large' loading={loading} onClick={() => RegisterClient()}>
                        Cadastrar Cliente
                    </Button>
                ...
                <Modal
                    title={`Cadastrar veículo do cliente: ${nameClient}`}
                    ...
                    footer={[
                        ...
                        <Button key="submit" icon='save' type="primary" loading={loadingCar} onClick={() => RegisterCar()}>
                            Cadastrar
                        </Button>,
                    ]}
                    width='70%'
                ...
                <Modal
                    ...
                    footer={[
                        ...
                        <Button key="submit" icon='save' type="primary" loading={loadingAddress} onClick={() => RegisterAddress()}>
                            Cadastrar
                        </Button>,
                    ]}
                    width='70%'
                ...
                >
                    ...
                    <Row gutter={10}>
                        ...
                        <Col span={4}>
                            ...
                            <Input type='text' onChange={(e) => setNumero(e.target.value.toUpperCase())} value={numero} />
                        </Col>
