...
export default function AddContasPagar() {
    ...
    async function allClear(){
        await setTitle(''); await setPlanoContaId(''); await setPlanoContaName(''); await setFormaPagamentoId(''); await setContasBancariaId(''); await setVencimento(''); await setValor(0); await setStatus('');
    }
    ...
    async function saveContReceive() {
        ...
        setLoading(true);
        await api.post('/financial/createContasPagar',{
            ...
            <Spin spinning={spinner} size='large'>
                <Row gutter={10}>
                    ...
                    <Col span={12}>
                        ...
                        <label>Descrição do pagamento<span style={{ color: 'red' }}>*</span></label>
