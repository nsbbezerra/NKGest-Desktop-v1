...
export default function OrdensAnalise() {
    ...
    async function findStatus(id) {
        setSpinner(true);
        await api.post('/orders/findStatusOrder', {
            idOrder: id._id
        }).then(response => {
    ...
    function warning() {
        Modal.warning({
            title: 'ATENÇÃO',
            content: 'Esta ordem de serviço ainda está em análise'
        });
    }
    ...
    function erro() {
        Modal.error({
            ...
            content: 'Esta ordem de serviço não foi autorizada'
        });
    }
    ...
    function sucesso() {
        Modal.success({
            title: 'AUTORIZADA',
            content: 'Esta ordem de serviço foi autorizada'
        });
    }
