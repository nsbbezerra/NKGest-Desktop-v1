...
export default function RelatorioServicos() {
    ...
    async function finder() {
        ...
        setLoading(true);
        await api.post('/report/listServices', {
            find: find
        }).then(response => {
    ...
    function printer() {
        ...
        <head>
            <title>Imprimir Relatório de Serviços</title>
                ...
                <div class="content">
                    ...
                    <table class="table-product" cellspacing='0'>
                        ...
                        <tbody>
                            ${servicos.map(ser => {
            return `<tr>
                                <td class="name2">${ser.name}</td>
                                <td class="price2">R$ ${ser.value}</td>
                                ${ser.active ? (`<td class="active2">Sim</td>`) : (`<td class="active2">Não</td>`)}
                            </tr>`
        }).join('')}
                        </tbody>
                    </table>
                    ...
                    <table class="table-resume">
                        ...
                        <thead>
                            <tr>
                                <td class="valueslast">TOTAL DOS SERVIÇOS</td>
                                <td class="moneylast">${totalServicos}</td>
                            </tr>
                        </thead>
        ...
        <>
            ...
            <div style={{ marginBottom: 10, width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Card size='small'>
                    ...
                    {find === 1 && (
                        <p style={{ marginBottom: -3, marginTop: -1 }}>Tipo dos dados: <strong>Serviços Ativos</strong></p>
                    )}
                    {find === 2 && (
                        <p style={{ marginBottom: -3, marginTop: -1 }}>Tipo dos dados: <strong>Serviços Bloqueados</strong></p>
                    )}
                    {find === 3 && (
                        <p style={{ marginBottom: -3, marginTop: -1 }}>Tipo dos dados: <strong>Todos os Serviços</strong></p>
                    )}
            ...
            <Table pagination={{ pageSize: 10 }} columns={columns} dataSource={servicos} size='small' style={{ marginTop: 15, marginBottom: 15 }} rowKey={(cli) => cli._id} />

            {totalServicos && (
                <Descriptions layout="vertical" bordered size='small'>
                    <Descriptions.Item label="Serviços Ativos" span={3}>{totalActive}</Descriptions.Item>
                    <Descriptions.Item label="Serviços Bloqueados" span={3}>{totalBlock}</Descriptions.Item>
                    <Descriptions.Item label="Total de Serviços" span={3}>{totalServicos}</Descriptions.Item>
                </Descriptions>
            )}
