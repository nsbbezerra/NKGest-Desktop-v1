...
export default function RelatorioFuncionarios() {
  ...
  const [totalFuncs, setTotalFuncs] = useState(null);
  ...
  function printer() {
    ...
    mywindow.document.write(`
        ...
        <head>
          <title>Imprimir Relatório de Funcionários</title>
              ...
              <table class="table-client" cellspacing='0'>
                <thead>
                  <tr>
                    ...
                    <td class="socialName">CARGO</td>
                    <td class="phone">FONE</td>
                    <td class="cel">ADMISSÃO</td>
      ...
      return `<tr>
              ...
              <table class="table-resume">
                  ...
                  <thead>
                    <tr>
                      <td class="values">TOTAL DOS FUNCIONÁRIOS ATIVOS</td>
                      <td class="money">${totalActive}</td>
                    </tr>
                    <tr>
                      <td class="values">TOTAL DOS FUNCIONÁRIOS BLOQUEADOS</td>
                      <td class="money">${totalBlock}</td>
                    </tr>
                    <tr>
                      <td class="valueslast">TOTAL DOS FUNCIONÁRIOS</td>
                      <td class="moneylast">${totalFuncs}</td>
                    </tr>
                  </thead>
