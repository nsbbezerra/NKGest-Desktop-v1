...
export default class Permissoes extends Component {
  ...
  sendUpdateFunc = async () => {
    ...
    await api
      .put(`/admin/changeFuncStatus/${this.state.idFunc}`, {
  ...
  sendActive = async () => {
    ...
    await api
      .put(`/admin/activeFunc/${this.state.idFunc}`, {
          ...
          <>
            <Tooltip placement="top" title="Gerenciar">
              <Button
                ...
                size="small"
                style={{ marginRight: 5 }}
                onClick={() => this.handleGetFuncInfo(id)}
              />
            </Tooltip>
          </>
        ),
        ...
        <Modal
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ modalFunc: false })}
            >
              Cancelar
            </Button>,
            <Button
            ...
            <Row gutter={8} style={{ marginBottom: 10 }}>
              ...
              <Col span={6}>
                ...
                <Select
                  ...
                  style={{ width: "100%" }}
                  onChange={(value) => this.setState({ cargo: value })}
                >
                  <Option key={1} value={"Administrador(a)"}>
                    Administrador(a)
                  </Option>
                  <Option key={2} value={"Diretor(a)"}>
                    Diretor(a)
                  </Option>
                  ...
                  <Option key={5} value={"Vendedor(a)"}>
                    Vendedor(a)
                  </Option>
                  <Option key={6} value={"Auxiliar de Almoxarifado"}>
                    Auxiliar de Almoxarifado
                  </Option>
                  <Option key={7} value={"Zelador(a)"}>
                    Zelador(a)
                  </Option>
                  ...
                  <Col span={8}>
                    ...
                    >
                      ...
                      <Switch
                        ...
                        onChange={(value) =>
                          this.setState({ comissioned: value })
                        }
                    ...
                    <Input
                      type="number"
                      addonAfter="%"
                      disabled={!this.state.comissioned}
                      onChange={(e) =>
