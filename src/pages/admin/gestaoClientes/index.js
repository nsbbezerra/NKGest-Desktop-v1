...
export default class GestaoDeClientes extends Component {
  ...
  handleInformation = async (id) => {
    ...
    await this.setState({
      municipalRegistration: result.municipalRegistration,
    });
  ...
  sendUpdateClient = async () => {
    ...
    await api
      .put(`/admin/editCliente/${this.state.idCliente}`, {
  ...
  sendUpdateAddress = async () => {
    ...
    await api
      .put(`/admin/editEndereco/${this.state.idAddress}`, {
  ...
  sendDelAddress = async () => {
    ...
    await api
      .delete(`/admin/delEndereco/${this.state.idAddress}`)
      .then((response) => {
  ...
  findAddress = async () => {
    this.setState({ loadingAddress: true });
    await api
      .get(`/admin/findAddressId/${this.state.idCliente}`)
      .then((response) => {
  ...
  sendActive = async () => {
    this.setState({ spinner: true });
    await api
      .put(`/admin/activeClients/${this.state.idCliente}`, {
  ...
  sendRestrict = async () => {
    this.setState({ spinner: true });
    await api
      .put(`/admin/restrictClients/${this.state.idCliente}`, {
          ...
          <>
            <Tooltip placement="top" title="Informações">
              <Button
                ...
                type="primary"
                size="small"
                onClick={() => this.handleInformation(_id)}
              />
            </Tooltip>
          </>
        ),
        ...
        <Modal
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ addressClient: false })}
            >
              Fechar
            </Button>,
          ]}
              ...
              <Row style={{ marginTop: 10 }}>
                <Col span={24} style={{ padding: 4 }}>
                  <Descriptions layout="vertical" bordered size="small">
                    ...
                    <Descriptions.Item label="Bairro" span={3}>
                      {this.state.address.bairro}
                    </Descriptions.Item>
                    <Descriptions.Item label="Complemento" span={3}>
                      {this.state.address.comp}
                    </Descriptions.Item>
                    ...
                    <Descriptions.Item label="Estaddo" span={3}>
              ...
              <div style={{ width: "100%" }}>
                ...
                >
                  ...
                  <Button
                    ...
                    size="default"
                    onClick={() =>
                      this.handleDelAddress(this.state.address._id)
                    }
                  >
                    Excluir endereço
                  </Button>
        ...
        <Modal
          ...
          footer={[
            ...
            <Button
              ...
              icon="save"
              type="primary"
              loading={this.state.loadingClient}
              onClick={() => this.sendUpdateClient()}
            >
              Salvar Alterações
            </Button>,
          ]}
              ...
              <Row style={{ marginBottom: 7 }}>
                ...
                <Col span={6} style={{ padding: 4 }}>
                  ...
                  <Input
                    type="number"
                    onChange={(e) =>
                      this.setState({ rg: e.target.value.toUpperCase() })
                    }
                    value={this.state.rg}
                  />
                </Col>
                ...
                <Col span={6} style={{ padding: 4 }}>
                  ...
                  <Input
                    type="text"
                    onChange={(e) =>
                      this.setState({ emitter: e.target.value.toUpperCase() })
                    }
                    value={this.state.emitter}
                  />
                </Col>
              ...
              <Row>
                <Col span={6} style={{ padding: 4 }}>
                  ...
                  <Input
                    type="text"
                    onChange={(e) =>
                      this.setState({ stateRegistration: e.target.value })
                    }
                ...
                <Col span={6} style={{ padding: 4 }}>
                  ...
                  <InputMask
                    ...
                    className="ant-input"
                    onChange={(e) =>
                      this.setState({ phoneComercial: e.target.value })
                    }
                    value={this.state.phoneComercial}
                  />
                </Col>
                ...
                <Col span={6} style={{ padding: 4 }}>
                  ...
                  <InputMask
                    mask={"99 99999-9999"}
                    className="ant-input"
                    onChange={(e) => this.setState({ celOne: e.target.value })}
                    value={this.state.celOne}
                  />
                </Col>
                ...
                <Col span={6} style={{ padding: 4 }}>
                  ...
                  <InputMask
                    mask={"99 99999-9999"}
                    className="ant-input"
                    onChange={(e) => this.setState({ celTwo: e.target.value })}
                    value={this.state.celTwo}
                  />
                </Col>
              </Row>
              ...
              <Row>
                <Col span={24} style={{ padding: 4 }}>
                  ...
                  <TextArea
                    rows={4}
                    onChange={(e) =>
                      this.setState({ obs: e.target.value.toUpperCase() })
                    }
            ...
            <>
              ...
              <Row>
                <Col span={12} style={{ padding: 4 }}>
                  ...
                  <Input
                    onChange={(e) =>
                      this.setState({ municipalRegistration: e.target.value })
                    }
                    value={this.state.municipalRegistration}
                  />
                </Col>
                ...
                <Col span={12} style={{ padding: 4 }}>
                  ...
                  <Input
                    type="text"
                    onChange={(e) =>
                      this.setState({ manager: e.target.value.toUpperCase() })
                    }
        ...
        <Modal
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ drawerAddress: false })}
            >
              Cancelar
            </Button>,
            <Button
              ...
              type="primary"
              loading={this.state.loadingAddress}
              onClick={() => this.sendUpdateAddress()}
            >
              Salvar Alterações
            </Button>,
          ]}
          ...
          <Row style={{ marginTop: 10 }}>
            <Col span={20} style={{ padding: 4 }}>
              ...
              <Input
                type="text"
                onChange={(e) =>
                  this.setState({ newRua: e.target.value.toUpperCase() })
                }
                value={this.state.newRua}
              />
            </Col>
            ...
            <Col span={4} style={{ padding: 4 }}>
              ...
              <Input
                type="text"
                onChange={(e) =>
                  this.setState({ newNumero: e.target.value.toUpperCase() })
                }
                value={this.state.newNumero}
              />
            </Col>
          </Row>
          ...
          <Row style={{ marginTop: 10 }}>
            <Col span={12} style={{ padding: 4 }}>
              ...
              <Input
                type="text"
                onChange={(e) =>
                  this.setState({ newComp: e.target.value.toUpperCase() })
                }
                value={this.state.newComp}
              />
            </Col>
            ...
            <Col span={12} style={{ padding: 4 }}>
              ...
              <Input
                type="text"
                onChange={(e) =>
                  this.setState({ newBairro: e.target.value.toUpperCase() })
                }
                value={this.state.newBairro}
              />
            </Col>
          </Row>
          ...
          <Row style={{ marginTop: 10 }}>
            <Col span={6} style={{ padding: 4 }}>
              ...
              <InputMask
                mask={"99.999-999"}
                className="ant-input"
                onChange={(e) => this.setState({ newCep: e.target.value })}
                value={this.state.newCep}
              />
            </Col>
            ...
            <Col span={12} style={{ padding: 4 }}>
              ...
              <Input
                type="text"
                onChange={(e) =>
                  this.setState({ newCidade: e.target.value.toUpperCase() })
                }
                value={this.state.newCidade}
              />
            </Col>
            ...
            <Col span={6} style={{ padding: 4 }}>
              ...
              <Select
                ...
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ newEstado: value })}
              >
        ...
        <Modal
          ...
          footer={[
            <Button
              ...
              type="danger"
              icon="close"
              onClick={() => this.setState({ modalDelEndereco: false })}
            >
              Não
            </Button>,
            <Button
