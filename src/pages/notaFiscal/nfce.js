...
export default class NotaFiscalNFCE extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      icms_margem_valor_adicionado_st: 0,
      icms_aliquota_st: 0,
      fcp_percentual: 0,
      fcp_percentual_st: 0,
      fcp_percentual_retido_st: 0,
  ...
  findRasc = async (id) => {
    ...
    await api
      ...
      .then((response) => {
        ...
        this.setState({
          natureza_operacao: response.data.rasc.natureza_operacao,
        });
        this.setState({ tipo_documento: response.data.rasc.tipo_documento });
        this.setState({
          finalidade_emissao: response.data.rasc.finalidade_emissao,
        });
        ...
        if (response.data.rasc.nome_fantasia_emitente) {
          this.setState({
            nome_fantasia_emitente: response.data.rasc.nome_fantasia_emitente,
          });
        }
        this.setState({
          logradouro_emitente: response.data.rasc.logradouro_emitente,
        });
        ...
        this.setState({
          municipio_emitente: response.data.rasc.municipio_emitente,
        });
        ...
        if (response.data.rasc.inscricao_estadual_emitente) {
          this.setState({
            inscricao_estadual_emitente:
              response.data.rasc.inscricao_estadual_emitente,
          });
        }
        this.setState({
          nome_destinatario: response.data.rasc.nome_destinatario,
        });
        if (response.data.rasc.cpf_destinatario) {
          this.setState({
            cpf_destinatario: response.data.rasc.cpf_destinatario,
          });
        } else {
          this.setState({
            cnpj_destinatario: response.data.rasc.cnpj_destinatario,
          });
        }
        ...
        this.setState({
          logradouro_destinatario: response.data.rasc.logradouro_destinatario,
        });
        this.setState({
          numero_destinatario: response.data.rasc.numero_destinatario,
        });
        this.setState({
          bairro_destinatario: response.data.rasc.bairro_destinatario,
        });
        this.setState({
          municipio_destinatario: response.data.rasc.municipio_destinatario,
        });
        this.setState({ uf_destinatario: response.data.rasc.uf_destinatario });
        this.setState({
          cep_destinatario: response.data.rasc.cep_destinatario,
        });
        this.setState({ valor_frete: response.data.rasc.valor_frete });
        this.setState({
          modalidade_frete: response.data.rasc.modalidade_frete,
        });
        if (response.data.rasc.inscricao_estadual_destinatario) {
          this.setState({
            inscricao_estadual_destinatario:
              response.data.rasc.inscricao_estadual_destinatario,
          });
        }
        if (response.data.rasc.informacoes_adicionais_contribuinte) {
          this.setState({
            informacoes_adicionais_contribuinte:
              response.data.rasc.informacoes_adicionais_contribuinte,
          });
        }
        if (response.data.rasc.notas_referenciadas.length) {
          this.setState({
            chave_nfe: response.data.rasc.notas_referenciadas[0].chave_nfe,
          });
        }
    ...
    Modal.success({
      ...
      content: (
        <div>
          <p>{message}</p>
          <p>
            <strong>STATUS SEFAZ:</strong> {status}
          </p>
          <p>
            <strong>MENSAGEM SEFAZ:</strong> {messageSefaz}
          </p>
        </div>
      ),
      onOk() {},
        ...
        <div>
          ...
          {erros ? (
            <>
              <label>ERROS:</label>
              {!!erros.length &&
                erros.map((err) => <p key={err.mensagem}>{err.mensagem}</p>)}
            </>
          ) : (
            ""
          )}
  ...
  allClear = () => {
    this.setState({ cfopAct: false });
    this.setState({ cfopValue: "" });
    this.setState({ typeDocument: "" });
    this.setState({ documentFinality: "" });
    this.setState({ freteModality: "" });
    this.setState({ freteValue: 0 });
    this.setState({ icmsCstAct: false });
    this.setState({ icmsCstValue: "" });
    this.setState({ pisCstAct: false });
    this.setState({ pisCstValue: "" });
    this.setState({ cofinsCstAct: false });
    this.setState({ cofinsCstValue: "" });
    this.setState({ items: [] });
    this.setState({ idNfeCorrect: "" });
    this.setState({ nfeKey: "" });
    this.setState({ serie: "" });
    this.setState({ numero_final: "" });
    this.setState({ numero_inicial: "" });
    this.setState({ infoAdd: "" });
    this.setState({ typeCfop: "" });
  ...
  generateRascSale = async () => {
    ...
    await api
      .post("/nfce/nfeRasc", {
        ...
        venda: this.state.idSale,
        cfop: {
          status: this.state.cfopAct,
          value: this.state.cfopValue,
          type: this.state.typeCfop,
        },
        config: {
          typeDocument: this.state.typeDocument,
          finality: this.state.documentFinality,
        },
        frete: { mode: this.state.freteModality, value: this.state.freteValue },
        icms: { status: this.state.icmsCstAct, cst: this.state.icmsCstValue },
        pis: { status: this.state.pisCstAct, cst: this.state.pisCstValue },
        cofins: {
          status: this.state.cofinsCstAct,
          cst: this.state.cofinsCstValue,
        },
        natOpe: this.state.natOpe,
        obs: this.state.infoAdd,
      })
      .then((response) => {
        this.allClear();
      ...
      .then((response) => {
        ...
        if (response.data.info === "erro_autorizacao") {
          ...
          this.erroSefaz(
            ...
            response.data.statuSefaz,
            response.data.messageSafaz
          );
          this.sendAdvancedFind();
          return false;
        }
        ...
        if (response.data.info === "cancelado") {
          this.setState({ modalVerify: false });
          this.erro("NFCE Cancelada", response.data.message);
          this.sendAdvancedFind();
          return false;
        }
  ...
  emmitNFE = async () => {
    ...
    await api
      .post("/nfce/nfe", {
        id: this.state.idToEmit,
        natureza_operacao: this.state.natureza_operacao,
        tipo_documento: this.state.tipo_documento,
        finalidade_emissao: this.state.finalidade_emissao,
        cnpj_emitente: this.state.cnpj_emitente,
        nome_emitente: this.state.nome_emitente,
        nome_fantasia_emitente: this.state.nome_fantasia_emitente,
        logradouro_emitente: this.state.logradouro_emitente,
        numero_emitente: this.state.numero_emitente,
        bairro_emitente: this.state.bairro_emitente,
        municipio_emitente: this.state.municipio_emitente,
        uf_emitente: this.state.uf_emitente,
        cep_emitente: this.state.cep_emitente,
        inscricao_estadual_emitente: this.state.inscricao_estadual_emitente,
        nome_destinatario: this.state.nome_destinatario,
        cpf_destinatario: this.state.cpf_destinatario,
        telefone_destinatario: this.state.telefone_destinatario,
        logradouro_destinatario: this.state.logradouro_destinatario,
        numero_destinatario: this.state.numero_destinatario,
        bairro_destinatario: this.state.bairro_destinatario,
        municipio_destinatario: this.state.municipio_destinatario,
        uf_destinatario: this.state.uf_destinatario,
      ...
      .then((response) => {
        ...
        if (response.data.info === "nfe_nao_autorizada") {
          this.setState({ modalEmit: false });
          this.erro("NFCE Não Autorizada", response.data.message);
          this.sendAdvancedFind();
          return false;
        }
        if (response.data.info === "nfe_autorizada") {
          this.setState({ modalEmit: false });
          this.erro("NFCE Autorizada", response.data.message);
          this.sendAdvancedFind();
          return false;
        }
        ...
        if (response.data.info === "erro_validacao_schema") {
          this.setState({ modalEmit: false });
          this.erroValidacao(
            "Erro de Validação do Esquema da Nota",
            response.data.message,
            response.data.erros
          );
          this.sendAdvancedFind();
  ...
  delRascNFE = async () => {
    this.setState({ loadingSendRasc: true });
    await api
      .delete(`/nfce/delRasc/${this.state.idSale}`)
      .then((response) => {
        this.setState({ loadingSendRasc: false });
  ...
  sendRascDevolve = async () => {
    this.setState({ loadingSendRasc: true });
    api
      .post("/nfce/nfeRascDev", {
        venda: this.state.idNfeCorrect,
        cfop: this.state.cfopValue,
        natOpe: this.state.natOpe,
        keyNfe: this.state.nfeKey,
        docType: this.state.typeDocument,
        finality: this.state.documentFinality,
        obs: this.state.infoAdd,
      })
      .then((response) => {
  ...
  sendCorrectNFE = async () => {
    this.setState({ loadingSendRasc: true });
    api
      .post("/nfce/cartaCorrect", {
        ref: this.state.idNfeCorrect,
        correct: this.state.correcao,
      })
      .then((response) => {
        this.setState({ loadingSendRasc: false });
  ...
  handleEditProduct = async (id) => {
    ...
    this.setState({
      valor_unitario_comercial: result.valor_unitario_comercial,
    });
    this.setState({
      valor_unitario_tributavel: result.valor_unitario_tributavel,
    });
    ...
    this.setState({
      icms_situacao_tributaria: result.icms_situacao_tributaria,
    });
    this.setState({ icms_origem: result.icms_origem });
    this.setState({ pis_situacao_tributaria: result.pis_situacao_tributaria });
    this.setState({
      cofins_situacao_tributaria: result.cofins_situacao_tributaria,
    });
    this.setState({ icms_aliquota: result.icms_aliquota });
    this.setState({
      icms_modalidade_base_calculo_st: result.icms_modalidade_base_calculo_st,
    });
    this.setState({
      icms_margem_valor_adicionado_st: result.icms_margem_valor_adicionado_st,
    });
    this.setState({ icms_aliquota_st: result.icms_aliquota_st });
    this.setState({ fcp_percentual: result.fcp_percentual });
    this.setState({
      fcp_percentual_retido_st: result.fcp_percentual_retido_st,
    });
    ...
    this.setState({
      cofins_aliquota_porcentual: result.cofins_aliquota_porcentual,
    });
    this.setState({
      ipi_codigo_enquadramento_legal: result.ipi_codigo_enquadramento_legal,
    });
  ...
  updateProduct = () => {
    if (this.state.descontoRef < this.state.valor_desconto) {
      this.warning(
        "Atenção",
        "O valor de desconto digitado é menor do que o restante do desconto"
      );
      return false;
    }
  ...
  setAllDescToProduct = async (id) => {
    ...
    if (valorDoProduto < this.state.valueDesconto) {
      this.warning(
        "Atenção",
        "O valor do produto é menor que o valor do desconto"
      );
      return false;
    }
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (value, info) => (
          <>
            {!value && (
              <Tooltip title="Consultar status da NFCE" placement="top">
                <Button
                  size="small"
                  type="link"
                  style={{
          ...
          <>
            {!info.rascunhoNFCE && (
              <Button
                ...
                style={{ width: "100%" }}
                type="default"
                onClick={() => this.handleRascSale(info._id)}
              >
                Gerar Rascunho
              </Button>
            )}
            {info.rascunhoNFCE === true && (
              <div style={{ width: "100%" }}>
                {!info.nfceStatus && (
                  <Dropdown
                    overlay={() => (
                      <Menu>
                        <Menu.Item
                          key="1"
                          onClick={() => this.findRasc(info._id)}
                        >
                          <Icon type="search" style={{ marginRight: 5 }} />
                          Visualizar e Emitir NFCE
                        </Menu.Item>
                        <Menu.Item
                          key="2"
                          onClick={() => this.handleDelRascNFE(info._id)}
                        >
                    ...
                    <Dropdown
                      overlay={() => (
                        <Menu>
                          ...
                          <Menu.Item
                            key="3"
                            onClick={() => this.handleSendEmail(info._id)}
                          >
                          ...
                          <Menu.Item
                            key="2"
                            onClick={() => this.handleCancelNFE(info._id)}
                          >
                            <Icon type="close" style={{ marginRight: 5 }} />
                            Cancelar NFCE
                          </Menu.Item>
                          ...
                          <Menu.Item
                            key="4"
                            onClick={() => this.handleDevolveRasc(info._id)}
                            disabled={!info.devolve ? false : true}
                          >
                          ...
                          <Menu.Item
                            key="5"
                            onClick={() => this.emitDevolveNFE(info._id)}
                            disabled={info.devolve ? false : true}
                          >
                            <Icon
                              type="cloud-upload"
                          ...
                          >
                            <Icon type="file-text" style={{ marginRight: 5 }} />
                            Documentos da NFCE de Devolução
                          </Menu.Item>
                          <Menu.Divider />
                          <Menu.Item
                            key="7"
                            onClick={() => this.handleCartaCorrect(info._id)}
                            disabled={!info.correct ? false : true}
                          >
                          ...
                          <Menu.Item
                            ...
                            onClick={() =>
                              this.handleDocuments(
                                info.pdfCartaCorrect,
                                info.xmlCartaCorrect,
                                info.number
                              )
                            }
                            disabled={info.correct ? false : true}
                ...
                {info.nfceStatus === "processando_autorizacao" && (
                  <Button
                    size="small"
                    icon="search"
                    type="default"
                ...
                {info.nfceStatus === "erro_autorizacao" && (
                  <Dropdown
                    overlay={() => (
                      <Menu>
                        <Menu.Item
                ...
                {info.nfceStatus === "cancelado" && (
                  <Button
                    size="small"
                    icon="file-text"
                    type="default"
                    onClick={() =>
                      this.handleDownloadXmlCancel(info.nfeXmlUrl, info.number)
                    }
                    style={{ width: "100%" }}
                  >
    ...
    const products = [
      {
        ...
        render: (id) => (
          <>
            ...
            <Tooltip
              placement="right"
              title="Adicionar todo o desconto a este produto"
            >
              <Button
                shape="circle"
                icon="percentage"
                type="default"
                size="small"
                onClick={() => this.setAllDescToProduct(id)}
              />
            </Tooltip>
          </>
        ),
      ...
      <>
          ...
          >
            {this.state.typeAdvandcedFind === 1 && (
              <p style={{ marginBottom: -3, marginTop: -1 }}>
                <strong>Vendas:</strong> Mês Atual
              </p>
            )}
            {this.state.typeAdvandcedFind === 2 && (
              <p style={{ marginBottom: -3, marginTop: -1 }}>
                <strong>Vendas, Cliente:</strong> {this.state.clientName}
              </p>
            )}
            {this.state.typeAdvandcedFind === 3 && (
              <p style={{ marginBottom: -3, marginTop: -1 }}>
                <strong>Vendas, Período:</strong> {this.state.mes} de{" "}
                {this.state.ano}
              </p>
            )}
            {this.state.typeAdvandcedFind === 4 && (
              <p style={{ marginBottom: -3, marginTop: -1 }}>
                <strong>Vendas, Número:</strong> {this.state.numberSale}
              </p>
            )}
        ...
        <Spin spinning={this.state.spinner} size="large">
          <Table
            ...
            size="small"
            rowKey={(sales) => sales._id}
            rowClassName={(record) => (record.devolve ? "red-row" : "")}
          />
          ...
          >
            ...
            <label style={{ marginLeft: 10 }}>
              Venda com NFCE de devolução emitida
            </label>
          </div>
        </Spin>
        ...
        >
          <Radio.Group
            onChange={(event) => {
              this.setState({ typeAdvandcedFind: event.target.value });
            }}
            ...
            <>
              ...
              >
                <Select
                  ...
                  onChange={(value) => this.setState({ mes: value })}
                >
                ...
                <Select
                  ...
                  style={{ width: 100 }}
                  onChange={(value) => this.setState({ ano: value })}
                >
          ...
          {this.state.typeAdvandcedFind === 4 && (
            <>
              ...
              <Input
                value={this.state.numberSale}
                onChange={(e) => this.setState({ numberSale: e.target.value })}
              />
            </>
          )}
        </Modal>
        ...
        <Modal
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ modalConfigRasc: false })}
            >
              Cancelar
            </Button>,
            <Button
              ...
              icon="save"
              type="primary"
              loading={this.state.loadingSendRasc}
              onClick={() => this.generateRascSale()}
            >
              Salvar Rascunho
            </Button>,
          ]}
        ...
        >
          ...
          <Row gutter={10}>
            <Col span={8}>
              <label>
                IMCS CSOSN - Usar novo valor?{" "}
                <Switch
                  checked={this.state.icmsCstAct}
                  onChange={(value) => this.setState({ icmsCstAct: value })}
              ...
              <Select
                value={this.state.icmsCstValue}
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ icmsCstValue: value })}
                disabled={!this.state.icmsCstAct}
              >
                <Option value={"101"}>
            ...
            <Col span={8}>
              <label>
                PIS CST - Usar novo valor?{" "}
                <Switch
                  checked={this.state.pisCstAct}
                  onChange={(value) => this.setState({ pisCstAct: value })}
                  checkedChildren={<Icon type="check" />}
                  unCheckedChildren={<Icon type="close" />}
                  style={{ marginTop: -5 }}
                />
              ...
              <Select
                value={this.state.pisCstValue}
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ pisCstValue: value })}
                disabled={!this.state.pisCstAct}
              >
            ...
            <Col span={8}>
              <label>
                COFINS CST - Usar novo valor?{" "}
                <Switch
                  checked={this.state.cofinsCstAct}
                  onChange={(value) => this.setState({ cofinsCstAct: value })}
                  checkedChildren={<Icon type="check" />}
                  unCheckedChildren={<Icon type="close" />}
                  style={{ marginTop: -5 }}
                />
              ...
              <Select
                value={this.state.cofinsCstValue}
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ cofinsCstValue: value })}
                disabled={!this.state.cofinsCstAct}
              >
                {this.state.pisCst.map((list) => (
                  <Option value={list.code} key={list.code}>
                    {list.desc}
          ...
          <Divider
            style={{ fontSize: 15, fontWeight: "bold", marginBottom: 1 }}
          >
          ...
          <Row gutter={10} style={{ marginBottom: 7 }}>
            <Col span={8}>
              <Row>
                <Col span={16} style={{ paddingRight: 2.5 }}>
                  <label>
                    CFOP - Usar novo valor?{" "}
                    <Switch
                      checked={this.state.cfopAct}
                      onChange={(value) => this.setState({ cfopAct: value })}
                      checkedChildren={<Icon type="check" />}
                      unCheckedChildren={<Icon type="close" />}
                      style={{ marginTop: -5 }}
                    />
                  ...
                  <Input
                    value={this.state.cfopValue}
                    onChange={(e) =>
                      this.setState({ cfopValue: e.target.value })
                    }
                    disabled={!this.state.cfopAct}
                  />
                </Col>
                <Col span={8} style={{ paddingLeft: 2.5 }}>
                  <label>Tipo Operação</label>
                  <Select
                    value={this.state.typeCfop}
                    style={{ width: "100%" }}
                    onChange={(value) => this.setState({ typeCfop: value })}
                  >
            ...
            <Col span={8}>
              ...
              <Select
                value={this.state.freteModality}
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ freteModality: value })}
              >
            ...
            <Col span={8}>
              ...
              <Input
                ...
                onChange={(e) => this.setState({ freteValue: e.target.value })}
              />
            </Col>
          </Row>
          ...
          <Row gutter={10} style={{ marginBottom: 7 }}>
            <Col span={12}>
              ...
              <Select
                value={this.state.natOpe}
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ natOpe: value })}
              >
                <Option value={"VENDA AO CONSUMIDOR"}>
                  Venda ao Consumidor
                </Option>
                <Option value={"COMPRA DE PRODUTOS"}>Compra de Produtos</Option>
                <Option value={"DEVOLUÇÃO DE MERCADORIA"}>
            ...
            <Col span={6}>
              ...
              <Select
                ...
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ typeDocument: value })}
              >
            ...
            <Col span={6}>
              ...
              <Select
                value={this.state.documentFinality}
                style={{ width: "100%" }}
                onChange={(value) => this.setState({ documentFinality: value })}
              >
          ...
          <Row gutter={10}>
            <Col span={24}>
              ...
              <TextArea
                ...
                onChange={(e) =>
                  this.setState({ infoAdd: e.target.value.toUpperCase() })
                }
              />
            </Col>
          </Row>
          ...
          <label style={{ color: "red" }}>
            Se optar por não usar um novo valor a NFCE será emitida com os
            valores cadastrado nos produtos
          </label>
        </Modal>

        <Modal
          visible={this.state.modalCorrectNfe}
          title="Rascunho NFCE de Devolução"
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ modalCorrectNfe: false })}
            >
              Cancelar
            </Button>,
            <Button
        ...
        >
          ...
          <Row gutter={10} style={{ marginBottom: 7 }}>
            ...
            <Col span={12}>
              <label>Chave da NFCE</label>
              <Input
                value={this.state.nfeKey}
                onChange={(e) => this.setState({ nfeKey: e.target.value })}
              />
            </Col>
          </Row>
        ...
        <Modal
          ...
          title="Justificativa de Cancelamento da NFCE"
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ modalJustify: false })}
            >
              Cancelar
            </Button>,
            <Button
        ...
        >
          <TextArea
            ...
            onChange={(e) =>
              this.setState({ justify: e.target.value.toUpperCase() })
            }
          />
        </Modal>
        ...
        <Modal
          ...
          title="Carta de Correção da NFCE"
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ modalCorrect: false })}
            >
              Cancelar
            </Button>,
            <Button
        ...
        >
          <TextArea
            rows={4}
            value={this.state.correcao}
            onChange={(e) => this.setState({ correcao: e.target.value })}
          />
        </Modal>

        <Modal
          visible={this.state.modalDelRasc}
          title="Excluir Rascunho da NFCE"
          ...
          footer={[
            <Button
              ...
              icon="close"
              type="danger"
              onClick={() => this.setState({ modalDelRasc: false })}
            >
              Não
            </Button>,
            <Button
          ...
          width="45%"
        >
          <p>Tem certeza que deseja excluir o rascunho da NFCE?</p>
        </Modal>

        <Modal
          visible={this.state.modalRasc}
          title="Rascunho da NFCE"
          ...
          footer={[
            <Input
              ...
              value={this.replaceValue(this.state.valueBruto)}
              readOnly
            />,
            <Input
              key="liquid"
              ...
              value={this.replaceValue(this.state.valueLiquid)}
              readOnly
            />,
            <Input
              key="desc"
              type="number"
              addonBefore="Desconto"
              addonAfter="R$"
              style={{ width: 280, marginRight: 10 }}
              value={this.state.valueDesconto}
              readOnly
            />,
            <Button
              key="submit"
        ...
        >
          <Tabs defaultActiveKey="1" type="card">
            <TabPane tab={<span>Emitente</span>} key="1">
              <Row gutter={10} style={{ marginBottom: 7 }}>
                <Col span={16}>
                  <label>Nome / Razão Social</label>
                  <Input
                    value={this.state.nome_emitente}
                    onChange={(e) =>
                      this.setState({
                        nome_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={8}>
                  ...
                  <Input
                    value={this.state.nome_fantasia_emitente}
                    onChange={(e) =>
                      this.setState({
                        nome_fantasia_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
              ...
              <Row gutter={10}>
                <Col span={8}>
                  <label>CNPJ</label>
                  <Input
                    value={this.state.cnpj_emitente}
                    onChange={(e) =>
                      this.setState({
                        cnpj_emitente: e.target.value.toUpperCase(),
                      })
                    }
                    disabled={this.state.cnpj_emitente ? false : true}
                  />
                </Col>
                <Col span={8}>
                  <label>CPF</label>
                  <Input
                    value={this.state.cpf_emitente}
                    onChange={(e) =>
                      this.setState({
                        cpf_emitente: e.target.value.toUpperCase(),
                      })
                    }
                    disabled={this.state.cpf_emitente ? false : true}
                  />
                </Col>
                <Col span={8}>
              ...
              <Row gutter={10} style={{ marginBottom: 7 }}>
                <Col span={20}>
                  ...
                  <Input
                    value={this.state.logradouro_emitente}
                    onChange={(e) =>
                      this.setState({
                        logradouro_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={4}>
                  <label>Número</label>
                  <Input
                    value={this.state.numero_emitente}
                    onChange={(e) =>
                      this.setState({
                        numero_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
              ...
              <Row gutter={10} style={{ marginBottom: 7 }}>
                <Col span={6}>
                  <label>Bairro</label>
                  <Input
                    value={this.state.bairro_emitente}
                    onChange={(e) =>
                      this.setState({
                        bairro_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={8}>
                  ...
                  <Input
                    value={this.state.municipio_emitente}
                    onChange={(e) =>
                      this.setState({
                        municipio_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={4}>
                  <label>Estado</label>
                  <Input
                    value={this.state.uf_emitente}
                    onChange={(e) =>
                      this.setState({
                        uf_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={6}>
                  <label>CEP</label>
                  <Input
                    value={this.state.cep_emitente}
                    onChange={(e) =>
                      this.setState({
                        cep_emitente: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
            ...
            <TabPane tab={<span>Destinatário</span>} key="2">
              <Row gutter={10} style={{ marginBottom: 7 }}>
                <Col span={16}>
                  <label>Nome / Razão Social</label>
                  <Input
                    value={this.state.nome_destinatario}
                    onChange={(e) =>
                      this.setState({
                        nome_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
              ...
              <Row gutter={10}>
                <Col span={6}>
                  <label>CNPJ</label>
                  <Input
                    value={this.state.cnpj_destinatario}
                    onChange={(e) =>
                      this.setState({
                        cnpj_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                    disabled={this.state.cnpj_destinatario ? false : true}
                  />
                </Col>
                <Col span={6}>
                  <label>CPF</label>
                  <Input
                    value={this.state.cpf_destinatario}
                    onChange={(e) =>
                      this.setState({
                        cpf_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                    disabled={this.state.cpf_destinatario ? false : true}
                  />
                </Col>
                <Col span={6}>
                  <label>Inscrição Estadual</label>
                ...
                <Col span={6}>
                  ...
                  <Input
                    value={this.state.telefone_destinatario}
                    onChange={(e) =>
                      this.setState({
                        telefone_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
              ...
              <Row gutter={10} style={{ marginBottom: 7 }}>
                <Col span={20}>
                  <label>Logradouro</label>
                  <Input
                    value={this.state.logradouro_destinatario}
                    onChange={(e) =>
                      this.setState({
                        logradouro_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={4}>
                  <label>Número</label>
                  <Input
                    value={this.state.numero_destinatario}
                    onChange={(e) =>
                      this.setState({
                        numero_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
              ...
              <Row gutter={10} style={{ marginBottom: 7 }}>
                <Col span={6}>
                  <label>Bairro</label>
                  <Input
                    value={this.state.bairro_destinatario}
                    onChange={(e) =>
                      this.setState({
                        bairro_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={8}>
                  <label>Município</label>
                  <Input
                    value={this.state.municipio_destinatario}
                    onChange={(e) =>
                      this.setState({
                        municipio_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={4}>
                  <label>Estado</label>
                  <Input
                    value={this.state.uf_destinatario}
                    onChange={(e) =>
                      this.setState({
                        uf_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
                <Col span={6}>
                  <label>CEP</label>
                  <Input
                    value={this.state.cep_destinatario}
                    onChange={(e) =>
                      this.setState({
                        cep_destinatario: e.target.value.toUpperCase(),
                      })
                    }
                  />
                </Col>
            ...
            <TabPane tab={<span>Produtos</span>} key="3">
              <Table
                columns={products}
            ...
            <TabPane tab={<span>Outros</span>} key="4">
              <Row gutter={10} style={{ marginBottom: 7 }}>
                <Col span={6}>
                  <label>Modalidade Frete</label>
                  <Select
                    value={this.state.modalidade_frete}
                    style={{ width: "100%" }}
                    onChange={(value) =>
                      this.setState({ modalidade_frete: value })
                    }
                  >
                    <Option value={"0"}>Por conta do Emitente</Option>
                    <Option value={"1"}>Por conta do Destinatário</Option>
                ...
                <Col span={6}>
                  <label>Valor do Frete</label>
                  <Input
                    value={this.state.valor_frete}
                    onChange={(e) =>
                      this.setState({ valor_frete: e.target.value })
                    }
                    readOnly
                  />
                </Col>
                <Col span={6}>
                  ...
                  <Select
                    ...
                    style={{ width: "100%" }}
                    onChange={(value) =>
                      this.setState({ tipo_documento: value })
                    }
                  >
                    <Option value={"0"}>Nota Fiscal de Entrada</Option>
                    <Option value={"1"}>Nota Fiscal de Saída</Option>
                ...
                <Col span={6}>
                  <label>Finalidade do Documento</label>
                  <Select
                    value={this.state.finalidade_emissao}
                    style={{ width: "100%" }}
                    onChange={(value) =>
                      this.setState({ finalidade_emissao: value })
                    }
                  >
                    <Option value={"1"}>Normal</Option>
                    <Option value={"2"}>Complementar</Option>
              ...
              <Row gutter={10}>
                <Col span={24}>
                  <label>Notas Referenciadas - Chave da NFCE</label>
                  <Input
                    value={this.state.chave_nfe}
                    onChange={(e) =>
                      this.setState({ chave_nfe: e.target.value.toUpperCase() })
                    }
                  />
                </Col>
              </Row>
        ...
        >
          ...
          >
            <Radio.Group
              onChange={(e) => this.setState({ modeFile: e.target.value })}
              value={this.state.modeFile}
            >
        ...
        >
          ...
          <Row gutter={10} style={{ marginBottom: 7 }}>
            ...
            <Col span={6}>
              <label>NCM</label>
              <Input
                value={this.state.codigo_ncm}
                onChange={(e) => this.setState({ codigo_ncm: e.target.value })}
              />
            </Col>
          </Row>
          <Row gutter={10} style={{ marginBottom: 7 }}>
            <Col span={8}>
              ...
              <Input
                value={this.replaceValue(this.state.valor_unitario_comercial)}
                readOnly
                addonAfter="R$"
              />
            </Col>
            <Col span={8}>
              ...
              <Input
                value={this.replaceValue(this.state.valor_bruto)}
                readOnly
                addonAfter="R$"
              />
            </Col>
            <Col span={8}>
              ...
              <Input
                value={this.state.valor_desconto}
                onChange={(e) =>
                  this.setState({ valor_desconto: e.target.value })
                }
                addonAfter="R$"
              />
            </Col>
          ...
          <Row gutter={10} style={{ marginBottom: 7 }}>
            <Col span={8}>
              ...
              <Select
                value={this.state.icms_situacao_tributaria}
                style={{ width: "100%" }}
                onChange={(value) =>
                  this.setState({ icms_situacao_tributaria: value })
                }
              >
                <Option value={"101"}>
                  101 - Tributada pelo Simples Nacional com permissão de crédito
            ...
            <Col span={8}>
              ...
              <Select
                value={this.state.icms_origem}
                style={{ width: "100%", marginBottom: 10 }}
                onChange={(value) => this.setState({ icms_origem: value })}
              >
                ...
                <Option value={"8"}>
                  8 - Nacional, mercadoria ou bem com Conteúdo de Importação
                  superior a 70%;
                </Option>
              </Select>
            </Col>
            <Col span={8}>
              ...
              <Input
                type="number"
                value={this.state.icms_aliquota}
                onChange={(e) =>
                  this.setState({ icms_aliquota: e.target.value })
                }
              />
            </Col>
          </Row>
          <Row gutter={10} style={{ marginBottom: 7 }}>
            <Col span={8}>
              ...
              <Input
                type="number"
                value={this.state.icms_aliquota_st}
                onChange={(e) =>
                  this.setState({ icms_aliquota_st: e.target.value })
                }
              />
            </Col>
            <Col span={8}>
              ...
              <Input
                type="number"
                value={this.state.icms_margem_valor_adicionado_st}
                onChange={(e) =>
                  this.setState({
                    icms_margem_valor_adicionado_st: e.target.value,
                  })
                }
              />
            </Col>
            <Col span={8}>
              ...
              <Select
                value={this.state.icms_modalidade_base_calculo_st}
                style={{ width: "100%", marginBottom: 10 }}
                onChange={(value) =>
                  this.setState({ icms_modalidade_base_calculo_st: value })
                }
              >
          ...
          <Row gutter={10} style={{ marginBottom: 7 }}>
            <Col span={8}>
              ...
              <Input
                type="number"
                value={this.state.fcp_percentual}
                onChange={(e) =>
                  this.setState({ fcp_percentual: e.target.value })
                }
              />
            </Col>
            <Col span={8}>
              ...
              <Input
                type="number"
                value={this.state.fcp_percentual_st}
                onChange={(e) =>
                  this.setState({ fcp_percentual_st: e.target.value })
                }
              />
            </Col>
            <Col span={8}>
              ...
              <Input
                type="number"
                value={this.state.fcp_percentual_retido_st}
                onChange={(e) =>
                  this.setState({ fcp_percentual_retido_st: e.target.value })
                }
              />
            </Col>
          </Row>
          <Row gutter={10} style={{ marginBottom: 7 }}>
            <Col span={12}>
              <label>IPI CST</label>
              <Select
                value={this.state.ipi_situacao_tributaria}
                style={{ width: "100%" }}
                onChange={(value) =>
                  this.setState({ ipi_situacao_tributaria: value })
                }
              >
            ...
            <Col span={6}>
              ...
              <Input
                type="number"
                value={this.state.ipi_aliquota}
                onChange={(e) =>
                  this.setState({ ipi_aliquota: e.target.value })
                }
              />
            </Col>
            <Col span={6}>
              ...
              <Input
                type="number"
                value={this.state.ipi_codigo_enquadramento_legal}
                onChange={(e) =>
                  this.setState({
                    ipi_codigo_enquadramento_legal: e.target.value,
                  })
                }
              />
            </Col>
          ...
          <Row gutter={10}>
            <Col span={6}>
              ...
              <Select
                value={this.state.pis_situacao_tributaria}
                style={{ width: "100%" }}
                onChange={(value) =>
                  this.setState({ pis_situacao_tributaria: value })
                }
              >
                {this.state.pisCst.map((list) => (
                  <Option value={list.code} key={list.code}>
            ...
            <Col span={6}>
              ...
              <Input
                type="number"
                value={this.state.pis_aliquota_porcentual}
                onChange={(e) =>
                  this.setState({ pis_aliquota_porcentual: e.target.value })
                }
              />
            </Col>
            <Col span={6}>
              ...
              <Select
                value={this.state.cofins_situacao_tributaria}
                style={{ width: "100%" }}
                onChange={(value) =>
                  this.setState({ cofins_situacao_tributaria: value })
                }
              >
                {this.state.pisCst.map((list) => (
                  <Option value={list.code} key={list.code}>
            ...
            <Col span={6}>
              ...
              <Input
                type="number"
                value={this.state.cofins_aliquota_porcentual}
                onChange={(e) =>
                  this.setState({ cofins_aliquota_porcentual: e.target.value })
                }
              />
            </Col>
          </Row>
