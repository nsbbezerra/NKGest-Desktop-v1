...
export default class NotaFiscalNFE extends Component {
  ...
  delRascNFE = async () => {
    this.setState({ loadingSendRasc: true });
    await api
      .delete(`/invoices/delRasc/${this.state.idSale}`)
      .then((response) => {
        this.setState({ loadingSendRasc: false });
      ...
      <>
        ...
        <Spin spinning={this.state.spinner} size="large">
          ...
          >
            ...
            <label style={{ marginLeft: 10 }}>
              Venda com NFE de devolução emitida
            </label>
          </div>
        </Spin>
        ...
        >
          ...
          <label style={{ color: "red" }}>
            Se optar por não usar um novo valor a NFE será emitida com os
